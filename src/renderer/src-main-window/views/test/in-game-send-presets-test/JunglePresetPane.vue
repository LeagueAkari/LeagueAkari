<template>
  <div class="flex flex-col pt-2">
    ...
    <div class="pt-3">
      <div class="mb-2 text-xs font-semibold text-black/70 dark:text-white/70">展示模块</div>
...
import { provideCurrentPreset, providePlayerSelectionPreset, useJunglePreset } from './context'
...
const { preset, displayOptions, selectedDisplayItems } = junglePreset

provideCurrentPreset(junglePreset)
providePlayerSelectionPreset(junglePreset.playerSelection)
</script>
