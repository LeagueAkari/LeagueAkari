      ...
      >
        <NRadioGroup size="small" :value="flashPosition" @update:value="setFlashPosition">
          <div class="flex flex-col gap-1">
            ...
            <NRadio value="f" :title="t('OpggView.settings.flashPosition.options.f')">F</NRadio>
            <NRadio value="auto" :title="t('OpggView.settings.flashPosition.options.auto')">
              {{ t('OpggView.settings.flashPosition.auto') }}
            </NRadio>
          </div>
        </NRadioGroup>
      </ControlItem>
